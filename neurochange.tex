...
%% Last-Updated: 2019-05-14T19:43:48+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\propertitle}{Bayesian methods in neurscience:\\a transition tutorial%\\{\large ***}%
}% title uses LARGE; set Large for smaller
\newcommand*{\pdftitle}{Bayesian methods in neurscience: a transition tutorial}
